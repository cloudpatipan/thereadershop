                    ...
                    <div className="col-span-2">
                        <div className="mx-auto cursor-pointer relative w-full h-[14rem] overflow-hidden group rounded-lg">
                            ...
                            {newImage ? (
                                ...
                                <img className="w-full h-full object-cover" src={` https://c45c-2405-9800-b540-dc40-d538-9787-5ce1-fc75.ngrok-free.app/images/adsbanner/${image}`} alt={`รูปภาพของ ${id}`} />
                            ) : (
