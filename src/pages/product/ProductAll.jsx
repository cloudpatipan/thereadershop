                ...
                <Layout>
                    ...
                    <div className="border rounded-lg p-4">
                        <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                            ...
                            <div>
                                <h1 className="text-xl">หนังสือทั้งหมด</h1>
                            </div>
                            ...
                            <div className={`grid grid-container grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 my-1`}>
                                {displayedProducts.length > 0 ? (
                                    displayedProducts.map((product, index) => (
                                        <div key={index} className="overflow-hidden">
                                            ...
                                            <div className="mt-1">
                                                ...
                                                {product.qty > 0 ? (
                                                    <Button onClick={(e) => addToCart(product.id)} className={`w-full mt-1`} name={'เพิ่ม'} icon={<IoCartOutline size={20} />} />
                                                ) : (
                                    ...
                                    <div className="flex items-center justify-center rounded-lg col-span-3 md:col-span-6">
                                        <span className="text-xl">ไม่มีสินค้ายอดนิยม</span>
                                    </div>
                                )}
                            </div>
                        </div>
