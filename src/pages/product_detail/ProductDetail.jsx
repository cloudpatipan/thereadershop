                        ...
                        <div>
                            <div className="flex flex-col md:flex-row gap-8 justify-between p-4 border rounded-lg">
                                ...
                                <div className="w-full md:w-[30%] relative overflow-hidden rounded-lg group">
                                    ...
                                    {product.image ? (
                                        <img className="w-full h-full object-cover" src={`https://ef9c-2405-9800-b540-dc40-a46a-cab9-89b-365c.ngrok-free.app/images/product/${product.image}`} alt="" />
                                    ) : (
                                    ...
                                    <div>
                                        <ModalImage isOpen={isModalOpen} onClose={closeModal}>
                                            {product.image ? (
                                                <img className="rounded-lg w-full h-full object-cover" src={`https://ef9c-2405-9800-b540-dc40-a46a-cab9-89b-365c.ngrok-free.app/images/product/${product.image}`} alt="" />
                                            ) : (
                                            ...
                                            <div key={index}>
                                                <a href={`/product/detail/${item.slug}`}>
                                                    <div className="relative overflow-hidden rounded-lg group">
                                                        ...
                                                        {item.image ? (
                                                            <img className="rounded-lg w-full h-full object-cover" src={`https://ef9c-2405-9800-b540-dc40-a46a-cab9-89b-365c.ngrok-free.app/images/product/${item.image}`} alt={item.name} />
                                                        ) : (
                                                            <img className="rounded-lg w-full h-full object-cover" src="https://ef9c-2405-9800-b540-dc40-a46a-cab9-89b-365c.ngrok-free.app/images/product/No_image.png" alt="No Image" />
                                                        )}
                                                    </div>
